...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Everlast Roof Rejuvenation — Add 15 Years to Your Shingles" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Everlast Roof Rejuvenation" },
      { property: "og:title", content: "Everlast Roof Rejuvenation — Add 15 Years to Your Shingles" },
      {
